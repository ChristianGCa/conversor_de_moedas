...
*   [API HG Brasil Finance](https://hgbrasil.com/status/finance) -  API utilizada para obter as taxas de câmbio.  **Observação:** A chave da API está exposta no código. Em um aplicativo real, utilize variáveis de ambiente para proteger a chave.

## Capturas de tela

<img alt="screenshot" src="./screenshoots/screen.png">